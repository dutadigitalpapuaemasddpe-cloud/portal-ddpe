...
async function submitAssessment() {
  ...
  // Save to localStorage for result page + dashboard demo
  localStorage.setItem('ddpe_last_result', JSON.stringify({
  ...
  // Send to Formspree (user must replace FORM_ID)
  // Ganti FORM_ID dengan ID Formspree Anda yang mengarah ke dutadigitalpapuaemasddpe@gmail.com
  const FORMSPREE_ID = 'YOUR_FORMSPREE_ID'; // <-- GANTI INI
  ...
  try {
    ...
    console.warn('Email send failed (expected if Formspree not configured):', err);
  }
